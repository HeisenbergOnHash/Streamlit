      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-24 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-xl border border-gray-100 transform transition-all duration-300 hover:scale-105">
            <div className="h-12 w-12 bg-primary-50 rounded-full flex items-center justify-center mb-5">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-xl border border-gray-100 transform transition-all duration-300 hover:scale-105">
            <div className="h-12 w-12 bg-secondary-50 rounded-full flex items-center justify-center mb-5">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-xl border border-gray-100 transform transition-all duration-300 hover:scale-105">
            <div className="h-12 w-12 bg-accent-50 rounded-full flex items-center justify-center mb-5">
